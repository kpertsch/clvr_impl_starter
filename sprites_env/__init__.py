...
register(
    id='Sprites-v0',
    entry_point='core.sprites_env.envs.sprites:SpritesEnv',
...
register(
    id='SpritesState-v0',
    entry_point='core.sprites_env.envs.sprites:SpritesStateEnv',
    kwargs={'n_distractors': 0}
)
...
register(
    id='SpritesRepel-v0',
    entry_point='core.sprites_env.envs.sprites:SpritesRepelEnv',
    kwargs={'n_distractors': 0}
)
...
register(
    ...
    entry_point='core.sprites_env.envs.sprites:SpritesRepelStateEnv',
    kwargs={'n_distractors': 0}
)
